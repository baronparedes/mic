...
class GetInTouch extends Component {
    ...
    handleErrors() {
        ...
        if (this.state.lastname === '') errors.lastname = "*";
            ...
            <div className="container-fluid">
                ...
                <Form horizontal onSubmit={this.handleSubmit.bind(this)}>
                    <fieldset disabled={this.state.loading}>
                        <FormGroup controlId="form-firstname" validationState={this.determineValidationState(this.state.errors.firstname)}>
                        ...
                        <FormGroup controlId="form-lastname" validationState={this.determineValidationState(this.state.errors.lastname)}>
                            <Col componentClass={ControlLabel} sm={2}>
                                last name
                            </Col>
                            <Col sm={10}>
